    ...
    return(
        <div className='bug-create'>
            ...
            <form>
                ...
                <label>Steps:</label>
                <textarea name='steps' placeholder='Steps tp recreate the bug' required onChange={inputChanged} value={bugObject.steps}></textarea>
                ...
                <select name='assigned' onChange={inputChanged} value={bugObject.assigned}>
                    <option>LaVoy Glass</option>
                    <option>Joe Pesci</option>
                    <option>Mark Wahlberg</option>
